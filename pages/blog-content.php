        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="page-header">
              <h3 class="page-title"> Blog Admin </h3>
              ...
              <div class="col-12 grid-margin stretch-card">
                ...
                <div id="popup3" class="text-center" >
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> Unleash Your Creativity: Craft Compelling Blog Content </p>
                    <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputName1">Topic</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Blog Topic" name="topic" required>
                      </div>
                      <div class="form-group">
                    ...
                    <select class="form-control form-control-lg" id="category" name = "category">
                      ...
                      <option value = "Job Market Today">Job Market Today</option>
                      <option value = "Food, Drink & Hospital">Food, Drink & Hospital</option>
                      ...
                      <div class="form-group">
                        <label>Upload Image Describing Your Blog</label>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" name="blog-content"></textarea>
                      </div>
...
if(isset($_POST["submit"])) {
  ...
  $blog = mysqli_real_escape_string($con, $_POST['blog-content']);
  $image = $_FILES['file'];
  ...
  if (in_array($file_extension, $extensions)) {
    ...
    if (move_uploaded_file($imagefiletemp, $upload_image)) {
      $sql="INSERT INTO blog_content VALUES ('0', '$topic', '$upload_image', '$date', '$category', '$blog')";
